...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0B0F19] relative overflow-hidden border-t border-white/5 py-16 px-6 md:px-12 mt-auto">
      {/* Background Glow */}
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-16">
        {/* Brand Section */}
        <div>
          <div className="flex items-center gap-2 mb-6">
            <img src="/logo.svg" alt="EnergiaCerta Logo" className="w-10 h-10" />
            <span className="text-xl font-bold text-white tracking-tight">Energia<span className="text-primary">Certa</span></span>
          </div>
          <p className="text-gray-400 text-sm mb-6 font-medium flex items-center gap-2">
            Made in Portugal <span className="text-xs bg-primary/10 text-primary px-2 py-0.5 rounded border border-primary/20 uppercase tracking-wider">PT</span>
          </p>

          {/* Social Icons */}
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-primary/20 hover:text-white transition-all">
        ...
        <div className="flex gap-12 md:gap-24">
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              ...
              <li><Link to="/tarifarios" className="hover:text-primary transition-colors">Tarifários 2026</Link></li>
              <li><Link to="/upload" className="hover:text-primary transition-colors">Simulador</Link></li>
            </ul>
          </div>
          <div>
